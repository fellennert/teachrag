---
title: "Chapter 12: Text Preprocessing and Featurization"
published-title: text_preprocessing
engine: knitr
freeze: auto
...
sotu_20cent_tokenized_nostopwords_nonumbers_stemmed |> select(starts_with("token")) |> glimpse()

#SnowballC::getStemLanguages() # if you want to know the codes for other languages 
```
